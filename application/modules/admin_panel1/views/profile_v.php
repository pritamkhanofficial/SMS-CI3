                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <?php echo form_open_multipart(base_url('admin/form_basic_info'), array('id' => 'user_profile')); ?>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-success" name="submit" value="submit_basic_info"><i class="fas fa-sync"></i> Update</button>
                                            </div>
                                        </div>
                                        <?php echo form_close(); ?> 
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <?php echo form_open(base_url('admin/form_change_pass'), array('id' => 'change_pass')); ?>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            <label for="phone" class="col-sm-2 col-form-label"></label>
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-success" name="submit" value="submit_change_pass"><i class="fas fa-sync"></i> Change</button>
                                            </div>
                                        </div>
                                        <?php echo form_close(); ?> 
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <?php echo form_open(base_url('admin/form_change_username'), array('id' => 'change_username')); ?>
                                        <div class="row mb-3">
                                            <label for="new_username" class="col-sm-2 col-form-label">User Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="<?=$user->user_name?>" id="new_username" name="new_username" required>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row mb-3">
                                            <label for="phone" class="col-sm-2 col-form-label"></label>
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-success" name="submit" value="submit_change_username"><i class="fas fa-sync"></i> Update</button>
                                            </div>
                                        </div>
                                        <?php echo form_close(); ?> 
                                    </div>
