...
<head>
        ...
        <meta charset="utf-8" />
        <title>Error 403 | <?=WEBSITE_NAME_SHORT?></title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            ...
                            <h4 class="text-uppercase mt-4">Be gone fool!</h4>
                            <p class="text-muted">The action you have requested is not allowed. You either do not have access, or your login session has expired and you need to sign in again</p>
